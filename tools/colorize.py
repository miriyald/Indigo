...
PALETTE = [
    ...
    (0xF3 / 255, 0x9C / 255, 0x12 / 255, 1.0),  # 5 HOLE: amber
]
...
def colorize_font(font, ufo_font, targets, tolerance=BBOX_OVERLAP_TOLERANCE, verbose=False):
    glyf = font["glyf"]
    hmtx = font["hmtx"]
...
def main():
    ...
    color_layers, stats = colorize_font(font, ufo_font, targets, args.tolerance, args.verbose)
